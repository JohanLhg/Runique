...
import com.jlahougue.core.data.networking.constructRoute
import com.jlahougue.core.data.networking.delete
import com.jlahougue.core.data.networking.get
import com.jlahougue.core.data.networking.safeCall
import com.jlahougue.core.domain.run.RemoteRunDataSource
...
import com.jlahougue.core.domain.util.map
...
class KtorRemoteRunDataSource(
    ...
    override suspend fun deleteRun(runId: String): EmptyResult<DataError.Network> {
        return httpClient.delete(
            route = "/run",
            queryParameters = mapOf("id" to runId)
        )
    }
}