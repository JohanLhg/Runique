package com.jlahougue.run.presentation.active_run.service
...
class ActiveRunService : Service() {
    ...
    private val baseNotification by lazy {
        NotificationCompat.Builder(applicationContext, CHANNEL_ID)
            .setSmallIcon(com.jlahougue.core.presentation.designsystem.R.drawable.logo)
    ...
    private fun createrNotificationChannel() {
